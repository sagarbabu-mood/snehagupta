  ...
  return (
    <div className="navbar">
      <div className="navbar-main">
        ...
        <div className="nav-icons">
          <div className="search-bar">
            ...
            <button>
              <img src="https://media.istockphoto.com/id/1044689226/photo/magnifying-glass-isolated-on-white-background-with-clipping-path.webp?b=1&s=170667a&w=0&k=20&c=y164H2Ldt2ccaw6lV5Ju3iS_jR6_PdtVaGo3L1eSlHM=" alt="Search" />
            </button>
          </div>
          <div className="icon">
            <img src="https://media.istockphoto.com/id/1353567508/photo/shopping-cart-icon-message-bubble-or-e-commerce-buy-symbol-illustration-flat-design-and-shop.webp?b=1&s=170667a&w=0&k=20&c=AXPk_gvpb9HIIYl61yrXuwRqQPpFerhuSQxAl8nkvtI=" alt="Bag" />
          </div>
          <div className="icon">
            <img src="https://media.istockphoto.com/id/1251362621/photo/shopping-cart-vector-art-closeup-view.webp?b=1&s=170667a&w=0&k=20&c=wfBm1hd9T_CW9oxVec3SM3eDxYRRjkB0zHvzVR3WMm0=" alt="Cart" />
          </div>
          <div className="icon">
            <img src="https://images.unsplash.com/photo-1511367461989-f85a21fda167?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTJ8fHByb2ZpbGUlMjBpY29ufGVufDB8fDB8fHww" alt="Profile" />
          </div>
        </div>
      </div>
      ...
      <div className="bag-row">
        ...
        <div className="https://plus.unsplash.com/premium_photo-1676739688562-be22bd13b014?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MXx8c2xpbmclMjBiYWdzJTIwc21hbGwlMjBpbiUyMGJsYWNrfGVufDB8fDB8fHww">
          <img src="bag2.jpg" alt="Bag Type 2" />
